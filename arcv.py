...
class Jugador(object):
	def __init__(self,nombre):
		...
		self.hp = self.hp_max
		self.mp = self.mp_max
		self.habilidades = [MateriadeFuego(),Octacorte(),Placaje()]
	...
	def eleccion(self):
		print("\nElige una habilidad:\n")
		print("0 - Materia de Fuego (10 MP)")
		print("1 - Octacorte (5 MP)")
		print("2 - Placaje (0 MP)")
		x = input(">")
		return int(x)

class AI(object):
	def __init__(self):
		self.nombre = "Sephirot"
		self.hp_max = random.randrange(60,71)
		self.mp_max = random.randrange(30,41)
		self.fuerza = random.randrange(3,7)
		self.inteligencia = random.randrange(2,5)
...
class MateriadeFuego(object):
	def __init__(self):
		self.danio = 0
		self.nombre = "Materia de Fuego"
...
class Octacorte(object):
	def __init__(self):
		self.danio = 0
		self.nombre = "Octacorte"
